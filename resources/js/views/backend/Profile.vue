                          ...
                          <ul class="pagination">
                            ...
                            >
                              <a
                                class="page-link"
                                @click="
                                  getAllTreatmentes(pagination.prev_page_url)
                                "
                                href="#"
                                tabindex="-1"
                                >Previous</a
                            ...
                            >
                              <a
                                class="page-link"
                                @click="
                                  getAllTreatmentes(pagination.next_page_url)
                                "
                                href="#"
                                >Next</a
                              >
...
export default {
  ...
  methods: {
    ...
    async getAllTreatmentes(page_url) {
      let vm = this;
      id = this.$route.params.id;
      page_url = page_url || "my-treatments/";
      const response = await axios.get(
        process.env.MIX_API_BASE_URL + id + "/" + page_url,
        {
