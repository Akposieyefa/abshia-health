                                ...
                                <table class="table table-hover table-nowrap">
                                    ...
                                    >
                                        ...
                                        <td class="text-end">
                                            ...
                                            <button  @click="deleteAgent(agent.id)" type="button" class="btn btn-sm btn-square btn-neutral text-danger-hover">
                                ...
                                <nav aria-label="...">
                                    <ul class="pagination">
                                        <li v-bind:class="[{disabled: !pagination.prev_page_url}]" class="page-item">
                                            <a class="page-link"  @click="getAllAgents(pagination.prev_page_url)" href="#" tabindex="-1">Previous</a>
                                        </li>
                                        <li class="page-item disabled"><a class="page-link" href="#">Page {{ pagination.current_page}} of {{ pagination.last_page}} </a></li>
                                        <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item">
                                            <a class="page-link" @click="getAllAgents(pagination.next_page_url)" href="#">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div>
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="agent.details.name" class="form-control form-control-lg" id="name" aria-describedby="emailHelp" placeholder="Enter name">
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="text" v-model="agent.email" class="form-control form-control-lg" id="email" aria-describedby="emailHelp" placeholder="Enter email">
                            </div>
                            <div class="form-group">
                                <label for="phone">Phone Number</label>
                                <input type="text" v-model="agent.details.phone_number" class="form-control form-control-lg" id="phone" aria-describedby="emailHelp" placeholder="Enter phone number">
                            </div>
                            <div class="form-group">
                                <label for="phone">Lga</label>
                                <select id="lga" v-model="agent.details.lga_id" class="form-control form-control-lg">
                        ...
                        <div class="modal-footer border-top-0">
                            <button type="submit" @click="updateAgent(agent.id)" class="btn btn-sm btn-dark" v-if="edit">Update</button>
                            <button type="submit" @click="createAgent()" class="btn btn-sm btn-dark" v-else>Create</button>
                        </div>
                    </div>
                </div>
            </div>
